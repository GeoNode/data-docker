...
Verify that the preloaded `GeoServer Data Directory for GeoServer 2.12.x`_ build from Jenkins is actually there:

.. _GeoServer Data Directory for GeoServer 2.12.x: http://build.geonode.org/geoserver/latest/data-2.12.x.zip
...
A docker-compose.yml can be defined in such a way with a service that mounts this data directory from a `tag of Docker Hub builds`_, in this case the version for `GeoServer-GeoNode 2.12.x`_:

.. _tag of Docker Hub builds: https://hub.docker.com/r/geonode/geoserver_data/builds/

.. _GeoServer-GeoNode 2.12.x: https://github.com/GeoNode/geoserver-geonode-ext/tree/2.12.x
...
.. _geonode/geoserver_data:2.12.x: https://hub.docker.com/r/geonode/geoserver_data/builds/
